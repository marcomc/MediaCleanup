...
# [REMOVE IF UNUSED] Option 2: Web application (when "frontend" + "backend"
# detected)
backend/
├── src/
│   ├── models/
...
# [REMOVE IF UNUSED] Option 3: Mobile + API (when "iOS/Android"
# detected)
api/
...
| [e.g., Repo pattern] | [specific problem] | [why direct DB access fails] |
